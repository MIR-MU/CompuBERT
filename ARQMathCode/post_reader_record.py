from ARQMathCode.Entity_Parser_Record.comment_parser_record import CommentParserRecord
from ARQMathCode.Entity_Parser_Record.post_history_parser_record import PostHistoryParserRecord
from ARQMathCode.Entity_Parser_Record.post_link_parser_record import PostLinkParserRecord
from ARQMathCode.Entity_Parser_Record.post_parser_record import PostParserRecord
from ARQMathCode.Entity_Parser_Record.user_parser_record import UserParserRecord
from ARQMathCode.Entity_Parser_Record.vote_parser_record import VoteParserRecord
...
class DataReaderRecord:
    ...
    def __init__(self, root_file_path, ignore_post_history=True, limit_posts=None):
        """
