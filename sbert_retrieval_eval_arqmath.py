...
def get_questions(all_questions_ids, preproc="blank"):
    ...
    if preproc=="blank":
        ...
        postprocessor = PolishSubstituer('/home/xstefan3/arqmath/data/Collection_v1.0/formula_prefix.V1.0.tsv')
    elif preproc=="infix":
        postprocessor = InfixSubstituer('???')
    elif preproc=="external":
        postprocessor = ExternalSubstituer('/home/xstefan3/arqmath/data/Collection_Vit/Posts_V1_0_prefix.json.gz')
    else:
...
eval_all_dirs(["/home/xstefan3/arqmath/compubert/logs/train_sampled_eval%s" % i for i in [26]],
              "/home/xstefan3/arqmath/compubert/arqmath_eval_out",
              "arqmath_eval_summary_26.tsv",
              preproc="external")
print("done")
